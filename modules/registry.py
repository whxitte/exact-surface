...
MODULE_REGISTRY: tuple[ModuleSpec, ...] = (
    ...
    ModuleSpec("uncover", "recon", "uncover", "1", Action.PASSIVE_RECON,
    ...
    ModuleSpec("nuclei", "scanning", "nuclei", "1", Action.ACTIVE_SCAN,
    ...
    ModuleSpec("naabu", "ports", "naabu", "2", Action.PORT_SCAN,
               note="rate-capped; replaces masscan in v1"),
    ModuleSpec("masscan", "ports", "masscan", "2", Action.PORT_SCAN, enabled=False,
               note="DISABLED in v1 — needs dedicated netblocks (ADR-0004)"),
    ModuleSpec("nmap", "ports", "nmap", "2", Action.PORT_SCAN,
               note="--max-rate capped, safe scripts only"),
    ...
    ModuleSpec("preview_env", "osint", None, "2", Action.PASSIVE_RECON,
               note="detect Vercel/Netlify/CF-Pages/staging envs"),
    ModuleSpec("dork", "dorking", None, "2", Action.PASSIVE_RECON),
    ModuleSpec("cve_feed", "intelligence", None, "2", Action.PASSIVE_RECON,
    ...
    # -- Phase 3: expansion ------------------------------------------------
    ModuleSpec("dalfox", "scanning", "dalfox", "3", Action.ACTIVE_SCAN, enabled=False,
