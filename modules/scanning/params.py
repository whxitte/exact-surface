...
CANDIDATE_PARAMS: tuple[str, ...] = (
    "debug", "test", "admin", "is_admin", "isAdmin", "role", "trace", "verbose",
    "dev", "development", "staging", "preview", "draft", "internal",
    "show_errors", "showerrors", "display_errors", "error", "errors",
    "source", "src", "raw", "format", "output", "callback", "jsonp",
    "id", "user_id", "userid", "uid", "account", "account_id", "customer_id",
    "file", "path", "template", "page", "view", "include", "doc",
    "cmd", "exec", "query", "q", "search", "filter", "sort", "order",
